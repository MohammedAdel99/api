...
mixin _$ResultState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions networkException) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(NetworkExceptions networkException)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ErrorImpl<T> implements Error<T> {
  const _$ErrorImpl(this.networkException);
  ...
  @override
  String toString() {
    return 'ResultState<$T>.error(networkException: $networkException)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(networkException);
  }
...
abstract class Error<T> implements ResultState<T> {
  const factory Error(final NetworkExceptions networkException) =
      _$ErrorImpl<T>;
